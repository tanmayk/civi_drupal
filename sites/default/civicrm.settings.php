...
if (!empty($_SERVER['PRESSFLOW_SETTINGS'])) {
  ...
  if (!empty($env['conf']['pantheon_binding'])) {
    ...
    $civicrm_root = '/srv/bindings/' . $pantheon_conf['pantheon_binding'] . '/code/' . rtrim(drupal_get_path('module', 'civicrm'), 'drupal');
    define('CIVICRM_TEMPLATE_COMPILEDIR', '/srv/bindings/' . $pantheon_conf['pantheon_binding'] . '/code/' . 'sites/default/files/civicrm/templates_c/');
    ...
    $civicrm_setting['Directory Preferences']['extensionsDir'] = '/srv/bindings/' . $pantheon_conf['pantheon_binding'] . '/code/profiles/civi_drupal_kit/civicrm_extension/';
    $civicrm_setting['URL Preferences']['extensionsURL'] = $base_url . '/profiles/civi_drupal_kit/civicrm_extension/';
  }
}

/** -----------------------------------------------
 * Add local settings from civicrm.settings.local.php
 */
if (!defined('PANTHEON_ENVIRONMENT')) {
  # Load in additional site configuration settings.
  $local_settings = dirname(__FILE__) . '/civicrm.settings.local.php';
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '563f8e43d598af8ed1c5ac47fbd6f904');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/civi-drupal-kit/sites/default/files/civicrm/templates_c//mail.log');
// }
